...
_STRINGS = {
    "zh": {
        ...
        "wizard_q_codex_statusline": "启用 Codex Hook 信息卡",
        ...
        "wizard_summary_statusline": "Codex Hook 信息卡",
    ...
    "en": {
        ...
        "wizard_q_codex_statusline": "Enable Codex Hook status card",
        ...
        "wizard_summary_statusline": "Codex Hook status card",
